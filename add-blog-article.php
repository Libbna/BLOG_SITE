...
if (isset($_POST['submit'])) {
    ...
    if (!isset($error)) {
        try {
            ...
            $stmt = $db->query("INSERT INTO custom_lang (langCode, langTitle, langDesc, langContent, author, profileImage) VALUES ('$language', '$articleTitle', '$articleDesc', '$articleContent', '$articleAuthor', '$destinationFile')");
