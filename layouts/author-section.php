        ...
        <div class="row align-items-center">
            <div class="col-lg-3 col-sm-4 col-7 order-first">
                <div class="author-image">
                    <img src="assets/uploads/main-author.jpg" alt="" class="img-fluid">
                </div>
            </div>
            <div class="col-lg-9 col-sm-12 order-md-first mt-lg-0 mt-4">
                ...
                <ul class="author-icons mt-4 pl-0">
        ...
        <div class="container py-lg-3">
            <div class="row">
                <div class="col-lg-6">
                    <div class="slider-info">
                        <div class="img-circle">
                            <a href="author.html"><img src="assets/uploads/author1.jpg" class="img-fluid" alt="author image"></a>
                        </div>
                        <div class="message">
                ...
                <div class="col-lg-6">
                    <div class="slider-info">
                        <div class="img-circle">
                            <a href="author.html"><img src="assets/uploads/author2.jpg" class="img-fluid" alt="author image"></a>
                        </div>
                        <div class="message">
                            <ul class="blog-single-author-date d-flex align-items-center">
                ...
                <div class="col-lg-6">
                    <div class="slider-info">
                        <div class="img-circle">
                            <a href="author.html"><img src="assets/uploads/author3.jpg" class="img-fluid" alt="author image"></a>
                        </div>
                        <div class="message">
                            <ul class="blog-single-author-date d-flex align-items-center">
                ...
                <div class="col-lg-6">
                    <div class="slider-info">
                        <div class="img-circle">
                            <a href="author.html"><img src="assets/uploads/author4.jpg" class="img-fluid" alt="author image"></a>
                        </div>
                        <div class="message">
                            <ul class="blog-single-author-date d-flex align-items-center">
                ...
                <div class="col-lg-6">
                    <div class="slider-info">
                        <div class="img-circle">
                            <a href="author.html"><img src="assets/uploads/author5.jpg" class="img-fluid" alt="author image"></a>
                        </div>
                        <div class="message">
                            <ul class="blog-single-author-date d-flex align-items-center">
                ...
                <div class="col-lg-6">
                    <div class="slider-info">
                        <div class="img-circle">
                            <a href="author.html"><img src="assets/uploads/author6.jpg" class="img-fluid" alt="author image"></a>
                        </div>
                        <div class="message">
                            <ul class="blog-single-author-date d-flex align-items-center">
